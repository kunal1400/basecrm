...
class rdc
{
    ...
    private $db_config = array(
        "host" => "85254re.com.mysql",
        "database" => "85254re_com",
        "username" => "85254re_com",
        "password" => "eQXBhMGx"
    );
    public $email_config;
...
//----------------------------------------------------------</codenassor>
    ...
    private $text_to_sms_send_to = "6026946300@txt.att.net,4806281610@txt.att.net";
    ...
    {
        echo "<br>read and process email";
        $c=0;$c1=0;
        ...
        if ($emails) {
            ...
            echo "<br>Email:".$this->email_config["username"];
...
<Response>
	...
	//------------------------------------------------------------------------------------------------------------------------------
	 ...
	 // added by code nassor  
	function SendVCF($to1,$from1,$body,$vcfurl,$zip)
{
...
function makevcf($zip1)
{
    ...
    global $tempfilename;
   $vcard->savetolocal($tempfilename);
// echo message
// or
